  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4">
        <p className="text-5xl sm:text-4xl text-amber-600   !bg-clip-text md:text-6xl italic  mt-2 font-medium">
          I Captured
        </p>

        {/* النص الكبير */}
        <div className="flex items-center  justify-center font-extrabold text-5xl sm:text-7xl md:text-9xl tracking-[0.1em] uppercase text-white mt-4">
          <span>Y</span>
