  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4">
        <p className="text-[85px] text-amber-500   !bg-clip-text md:text-6xl italic  mt-2 font-medium">
          I Captured
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center font-semibold text-[147px]  tracking-[0.1em] uppercase text-white mt-4">
          <span>Y</span>
